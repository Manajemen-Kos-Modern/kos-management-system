...
<x-app-layout>
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <section class="riwayat-section">
                <div class="riwayat-header" style="background: #FFF9DB; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
                    ...
                    <table class="riwayat-table" style="width:100%; border-collapse:collapse; background:#fff;">
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom:2px solid #222;">
                                ...
                                <td style="padding:8px;">{{ \Carbon\Carbon::parse($pembayaran->created_at)->format('d/m/Y') }}</td>
                                <td style="padding:8px;">Rp {{ number_format($pembayaran->harga, 0, ',', '.') }}</td>
                                <td style="padding:8px;">Rp {{ number_format($pembayaran->harga, 0, ',', '.') }}</td>
                                <td style="padding:8px; text-transform:capitalize;">{{ $pembayaran->metode_pembayaran }}</td>
    ...
    @vite(['resources/css/riwayat-pembayaran.css', 'resources/css/dashboard.css', 'resources/js/dashboard.js'])
</x-app-layout>